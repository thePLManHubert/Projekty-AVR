...
#define LCD_RS_PIN  PORTC1
#define LCD_E_PIN   PORTC0
...
#define DATA_PIN_3     PORTC2 // MSB
#define DATA_PIN_2     PORTC3
#define DATA_PIN_1     PORTC4
#define DATA_PIN_0     PORTC5 // LSB
